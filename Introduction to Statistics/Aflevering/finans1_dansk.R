...
setwd("/Users/niclasjuulschaeffer/Desktop/finans1")
...
outliers <- data[data < lower.threshold | data > upper.threshold]

outliers


#Find Outliers i tabelen VAW
data <- D$VAW
