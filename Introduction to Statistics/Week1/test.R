...
plot(x, y, xlab = "Height", ylab = "Weight", cex = 1.5, col = "blue", type = "n") # nolint: line_length_linter.
...
plot(x, y1, pch = 19, cex = 0.5, ylab = "y", main = expression(r%~~%0.95), cex.main = 2) # nolint: line_length_linter.
plot(x, y2, pch = 19, cex = 0.5, ylab = "y", main = expression(r%~~%-0.5), cex.main = 2) # nolint: line_length_linter.
plot(x, y3, pch = 19, cex = 0.5, ylab = "y", main = expression(r%~~%0), cex.main = 2) # nolint: line_length_linter.
plot(x, y4, pch = 19, cex = 0.5, ylab = "y", main = expression(r%~~%0), cex.main = 2) # nolint: line_length_linter.
...
text(1.3, quantile(c(x, 235)), c("Minimum", "Q1", "Median", "Q3", "Maximum"), col = "blue") # nolint